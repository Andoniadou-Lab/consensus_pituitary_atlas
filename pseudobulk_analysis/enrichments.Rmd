...
```
# Enrichment for Lineage markers
...
# Repeating enrichment on the 2 month subset (for Reviewer 3)
```{r}
...
```
# Enrichment across temporal patterns
...
```{r}
table(ageing_res$change_pattern)
```
