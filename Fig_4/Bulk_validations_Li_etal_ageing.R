...
final_results = read.csv("/Users/k23030440/epitome_code/epitome/data/aging/v_0.02/aging_genes.csv")
#keep only padj < 0.05
...
#extract bulk RNA-seq degs
top_genes_li_df <- as.data.frame(topTable(fit2, coef = "YoungVsOld", n = Inf, sort.by = "P")
                                 )
#extract directional degs from pan pituitary ageing genes
...
# Plotting all variations of the data
...
####
#save plot to figs_folder - This is the figure that goes into the manuscript
####
...
### Repeat for 2 months+ analysis - This was only used in analysis towards the Response letter to the Reviewers.
final_results = read.csv("/Users/k23030440/epitome_code/epitome/data/aging/v_0.02/aging_genes_2_month.csv")
#keep only padj < 0.05
final_results_pan_pit <- final_results[final_results$adj.P.Val < 0.05,]
#calc avg logFC and geom avg adj pval
final_results_pan_pit$avg_logFC <- ave(final_results_pan_pit$logFC, final_results_pan_pit$genes, FUN = mean)
...
#save plot to figs_folder
ggsave(paste0(figs_folder, "volcano_plot_age_de_stem_li_min3_2_month.png"), plot = volcano_plot_with_gap, width = 4, height = 3)
#svg
ggsave(paste0(figs_folder, "volcano_plot_age_de_stem_li_min3_2_month.svg"), plot = volcano_plot_with_gap, width = 4, height = 3)
...
#save plot to figs_folder
ggsave(paste0(figs_folder, "volcano_plot_age_de_stem_li_ns_min3_2_month.png"), plot = volcano_plot_with_gap, width = 4, height = 3)
#svg
ggsave(paste0(figs_folder, "volcano_plot_age_de_stem_li_ns_min3_2_month.svg"), plot = volcano_plot_with_gap, width = 4, height = 3)
