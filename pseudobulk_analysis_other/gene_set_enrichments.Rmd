---
title: "Gene set enrichments with EnrichR"
author: "Bence Kover"
date: "2026-02-26"
...
# Load grouping markers from the CPA

```{r}

#load paste0("/Users/k23030440/epitome_code/epitome/markers/v_0.01/grouping_lineage_markers.csv"
markers = read.csv(file = "/Users/k23030440/epitome_code/epitome/data/markers/v_0.02/grouping_lineage_markers.csv", header = TRUE)

print(table(markers$grouping, markers$direction))

```

# Define the databases a priori ("Reactome_Pathways_2024", "WikiPathways_2024_Mouse","GO_Biological_Process_2023")
...
# Coefs table to extract background gene set for markers (e.g., genes that are expressed at all in the pituitary)
...
# Enrichment for Lineage markers in all groupings (up and downregulated markers)
...
# Summarizing results in an object
...
# Loading back the enrichment results. Identifying a curated set of interpretable pathways
...
# Analysing enriched terms in age-dependent genes
# First loading in age-dependent genes

```{r}

#load ageing genes "/Users/k23030440/epitome_code/epitome/aging/",version,".csv"
ageing_res = read.csv("/Users/k23030440/epitome_code/epitome/data/aging/v_0.02/aging_genes.csv")
...
# Perform enrichment in age-dependent genes of stem cells
...
# Repeating enrichment on the >2 months old subset (for Reviewer 3)
...
# Repeat enrichment across temporal patterns
...
ageing_res = ageing_res[ageing_res["cell_type"]=="Stem_cells",]
